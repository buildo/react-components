class Example extends React.Component {
  ...
  updateOutput = () => (
    this.setState({ flex: React.findDOMNode(this.refs.output).style.flex })
  );
  ...
  getValues = () => {
    ...
    return {
      grow: grow === 'true' ? true : (parseInt(grow) || undefined),
      shrink: shrink === 'true' ? true : (parseInt(shrink) || undefined),
