...
export class ScrollView<
  CP extends React.HTMLAttributes<any>,
  ICP extends React.HTMLAttributes<any>
> extends React.PureComponent<ScrollView.Props<CP, ICP>, State> {
  ...
  saveScrollbarsState() {
    ...
    if (
      this.state.isVerticalScrollbarVisible !== isVerticalScrollbarVisible ||
      this.state.isHorizontalScrollbarVisible !== isHorizontalScrollbarVisible
    ) {
      this.setState({
  ...
  wrapperRenderer = (props: CP) => {
    ...
    return React.createElement(component as any, wrapperProps, children);
  };
        ...
        >
          ...
          >
            <div
              className="thumb"
              ref={ref => {
                this.horizontalThumb = ref;
              }}
            />
          </div>
          <div className="gm-scroll-view">
            <ResizeSensor onResize={() => this.forceUpdate()}>
              <InnerWrapper {...innerComponentProps}>{children}</InnerWrapper>
            </ResizeSensor>
          </div>
        </Wrapper>
      </ResizeSensor>
