...
const toggable = () => <Toggle />;
const dropdownable = () => <Dropdown options={range(40).map(x => ({ label: x, value: x }))} value={random(30)} />;
const loadingspinnerable = () => <LoadingSpinner />;
  ...
  render() {
    return (
      <Tablo data={this.props.data} selectionType='none'>
        ...
        <Column name='city'>
          <Cell>{dropdownable}</Cell>
        </Column>

        <Column name='email'>
          <Cell>{loadingspinnerable}</Cell>
        </Column>
